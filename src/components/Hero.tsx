  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <p className="mt-6 text-2xl text-gray-300 max-w-3xl drop-shadow-md">
          Empowering businesses with secure and innovative software solutions.
        </p>
        <a
          href="/contact"
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <div className="absolute w-40 h-40 bg-blue-700 rounded-full opacity-20 animate-float-slow top-10 left-10"></div>
        <div className="absolute w-32 h-32 bg-purple-700 rounded-full opacity-15 animate-float-slow top-32 right-20"></div>
        <div className="absolute w-48 h-48 bg-pink-700 rounded-full opacity-10 animate-float-slow bottom-10 left-1/3"></div>
      </div>
